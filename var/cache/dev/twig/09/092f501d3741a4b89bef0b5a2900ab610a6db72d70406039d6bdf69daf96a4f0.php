...
class __TwigTemplate_d4c4b4cf0a193cd2dba7467cc23b43a6b4e34dd5e0a6389d871419664b243441 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<!-- Slide 2 -->
\t\t\t\t<div class=\"carousel-item\" style=\"background-image: url(assets/img/slide/irm1.jpg)\">
\t\t\t\t\t<div class=\"container\">
\t\t\t\t\t\t<h1>CIDIS</h1>
\t\t\t\t\t\t<h3 style=\"color: black;\">Centre D'imagerie Diagnostique et Interventionnelle De Soumbedioune</h3>
\t\t\t\t\t\t<a href=\"#about\" class=\"btn-get-started scrollto\">Lire la suite</a>
...
\t\t\t\t\t<p></p>
\t\t\t\t\t<a class=\"cta-btn scrollto\" href=\"/login\">PRENDRE RENDEZ-VOUS</a>
\t\t\t\t</div>
...
\t\t\t\t\t\t\t<h4>Imagerie</h4>
\t\t\t\t\t\t\t<p>L'imagerie médicale regroupe les moyens d'acquisition et de restitution d'images du corps humain à partir de différents phénomènes physiques tels que l'absorption des rayons X, la résonance magnétique.</p>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"icon-box mt-5\">
\t\t\t\t\t\t\t<i class=\"bx bx-cube-alt\"></i>
\t\t\t\t\t\t\t<h4>Scanner</h4>
\t\t\t\t\t\t\t<p>Un scanner est un appareil d'imagerie médicale qui utilise des rayons X.</p>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"icon-box mt-5\">
\t\t\t\t\t\t\t<i class=\"bx bx-images\"></i>
\t\t\t\t\t\t\t<h4>IRM</h4>
\t\t\t\t\t\t\t<p>Ensemble des techniques permettant d'obtenir des images à partir de la résonance magnétique nucléaire.</p>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"icon-box mt-5\">
\t\t\t\t\t\t\t<i class=\"bx bx-shield\"></i>
\t\t\t\t\t\t\t<h4>Radiologie</h4>
\t\t\t\t\t\t\t<p>Technique d'imagerie de transmission, par rayons X dans le cadre de la radiographie X, ou par rayons gamma en gammagraphie.</p>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
